...
chat_template = ChatPromptTemplate.from_messages(
    [
        ("system", """Task: You are a helpful assistant, expert on the core of Bantotal and Genexus 8, 9 y 16. 
         ...
         You must answer users question IN SPANISH. 
         Instructions: 
         - All information in your answers must be retrieved from your knowledge or based on previous information from the chat history. 
         - In case the question can not be answered based on your knowledge, you must ask the user to provide more information or context. Otherwise honestly say that you can not answer that question.
